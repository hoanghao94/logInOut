...
class MemberResourceIT {
    ...
    public static Member createEntity(EntityManager em) {
        Member member = new Member().userName(DEFAULT_USER_NAME).passWord(DEFAULT_PASS_WORD);
        return member;
    }
    ...
    public static Member createUpdatedEntity(EntityManager em) {
        Member member = new Member().userName(UPDATED_USER_NAME).passWord(UPDATED_PASS_WORD);
        return member;
    }
    ...
    void createMember() throws Exception {
        ...
        assertThat(testMember.getPassWord()).isEqualTo(DEFAULT_PASS_WORD);
    }
    ...
    void putExistingMember() throws Exception {
        ...
        assertThat(testMember.getPassWord()).isEqualTo(UPDATED_PASS_WORD);
    }
    ...
    void partialUpdateMemberWithPatch() throws Exception {
        ...
        partialUpdatedMember.userName(UPDATED_USER_NAME);
    ...
    void fullUpdateMemberWithPatch() throws Exception {
        ...
        partialUpdatedMember.userName(UPDATED_USER_NAME).passWord(UPDATED_PASS_WORD);
